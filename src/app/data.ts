...
export const experiences = [
  {
    ...
    detailsEn: "Graduated with focus on Business Administration and Economics. First contact with IT project management and web technologies in elective courses."
  },
  {
    id: "2",
  ...
  },
  {
    ...
    roleEn: "BSc Computer Science (Studies)",
  ...
  },
  {
    ...
    companyEn: "National Administration",
    period: "2022 - Heute",
    ...
    detailsEn: "Responsible for client management and 1st-level support. Direct contact with users sharpened my understanding of everyday usability issues."
  },
  {
    id: "5",
    role: "BSc Digital Design (Studium)",
    roleEn: "BSc Digital Design (Studies)",
    company: "Ostschweizer Fachhochschule",
    companyEn: "Eastern Switzerland University of Applied Sciences",
    period: "2024 - Heute",
